                    ...
                    query: ` 
                        ...
                        mutation {
                            ...
                            createRoastingLot(roastingLotInput: {
                                ...
                                actor: "${data.customData['ActorName.Measure'].value}"
                                roastDate: "${data.customData['TransformDate.MeasureTime'].dateTimeValue}"
                                notes: "${data.customData['Notes.Measure'].value}"
